...
export const EVENTS: ClubEvent[] = [
  ...
  },
  {
    ...
    start: '2026-09-27T17:30:00+05:30',
    ...
    longDescription: [
      'THE SECRET’S OUT. 🎤🪩',
      'GARBA GALA 2026’S SINGERS ARE FINALLY REVEALED! 🔥',
      'And trust us, you DON’T wanna be the one watching everyone’s stories wishing you were there. 👀',
      '🎟️ ₹400 ONLY · ⚡ FIRST 50 REGISTRATIONS',
      '50 spots. ₹400. Blink & they’re gone. 😭',
      '📅 27th September   📍 Grand Celebration Banquet, Mulund   🕐 5:30 PM onwards',
      'Register: https://tinyurl.com/2azemytt',
      'Payment: 9136240120@fam',
      'Get your squad. Lock your spot. Don’t let FOMO hit later. ❤️‍🔥',
    ],
