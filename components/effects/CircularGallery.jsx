...
// Vendored from React Bits (https://reactbits.dev) — CircularGallery.
// Adapted only to use a CSS Module import for Next.js App Router.
...
class App {
  ...
  addEventListeners() {
    ...
    // Wheel/drag are scoped to the gallery container so the component doesn't
    // hijack the page's smooth scroll while you're reading the rest of the page.
